            ...
            <div class="col-lg-6 col-md-6">
              <div class="panel panel-turq">
                ...
                <div class="col-lg-12 col-md-12">
                        <a ng-click="" class="waves-effect waves-light btn margin-bottom-1em">Edit</a>
                        <a ng-click="" class="waves-effect waves-light btn margin-bottom-1em">Back</a>
                    </div>
                  ...
                  <div class="form-group input-group"> <span class="input-group-addon">Email</span>
                    <input type="text" class="form-control" value="">
                  </div>
                </div>
              </div>
              ...
              <div class="col-lg-6 col-md-6">
                <div class="panel panel-turq">
                 <div class="panel-heading">
                  ...
                  <div class="panel-body">
                    <textarea rows="30" cols="85%"></textarea>
                  </div>
                </div>
              </div>
        <!-- END : COVER PANEL 2A  -->
