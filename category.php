        ...
        <div class="container" ng-app="sterlingCategoryApp" ng-controller="categoryCtrl">
            ...
            <div class="row">
                <table class="table table-hover">
                    ...
                    <tbody ng-init="get()">
                        <tr dir-paginate="cat in data.categories | filter:search | orderBy:sortKey | itemsPerPage:5" pagination-id="categoryx">
                            <td class="text-align-left">{{ cat.description }}</td>
                            <td class="text-align-left">{{ cat.code }}</td>
                            <td align="right">
                                <a ng-click="read(cat.id)" class="waves-effect waves-light btn margin-bottom-1em">Edit</a>
                                <a ng-click="delete(cat.id)" class="waves-effect waves-light btn margin-bottom-1em">Delete</a>
                            </td>
                        </tr>
                    </tbody>
                        <!-- angular pagination -->
